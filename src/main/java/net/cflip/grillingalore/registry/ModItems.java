...
public class ModItems {
	...
	public static final Item RAW_SAUSAGE = new Item(new FabricItemSettings().food(new FoodComponent.Builder().hunger(1).saturationModifier(0.2f).snack().build()));
	public static final Item GRILLED_SAUSAGE = new Item(new FabricItemSettings().food(new FoodComponent.Builder().hunger(4).saturationModifier(0.4f).snack().build()));
	public static final Item HOT_DOG = new Item(new FabricItemSettings().food(new FoodComponent.Builder().hunger(8).saturationModifier(0.2f).build()));
	public static final Item LOADED_DOG = new Item(new FabricItemSettings().food(new FoodComponent.Builder().hunger(11).saturationModifier(0.4f).build()));
	...
	public static void register() {
		...
		Registry.register(Registries.ITEM, new Identifier(GrillinGalore.MODID, "raw_sausage"), RAW_SAUSAGE);
		Registry.register(Registries.ITEM, new Identifier(GrillinGalore.MODID, "grilled_sausage"), GRILLED_SAUSAGE);
		Registry.register(Registries.ITEM, new Identifier(GrillinGalore.MODID, "hot_dog"), HOT_DOG);
		Registry.register(Registries.ITEM, new Identifier(GrillinGalore.MODID, "loaded_dog"), LOADED_DOG);
		...
		ItemGroupEvents.modifyEntriesEvent(ItemGroups.FOOD_AND_DRINK).register(entries -> entries.add(ONION));
		...
		ItemGroupEvents.modifyEntriesEvent(ItemGroups.NATURAL).register(entries -> entries.add(PEPPER_SEEDS));
		ItemGroupEvents.modifyEntriesEvent(ItemGroups.FOOD_AND_DRINK).register(entries -> entries.add(RED_PEPPER));
		ItemGroupEvents.modifyEntriesEvent(ItemGroups.FOOD_AND_DRINK).register(entries -> entries.add(GREEN_PEPPER));
		ItemGroupEvents.modifyEntriesEvent(ItemGroups.INGREDIENTS).register(entries -> entries.add(SARSAPARILLA));
		ItemGroupEvents.modifyEntriesEvent(ItemGroups.FOOD_AND_DRINK).register(entries -> entries.add(RAW_SAUSAGE));
		ItemGroupEvents.modifyEntriesEvent(ItemGroups.FOOD_AND_DRINK).register(entries -> entries.add(GRILLED_SAUSAGE));
		ItemGroupEvents.modifyEntriesEvent(ItemGroups.FOOD_AND_DRINK).register(entries -> entries.add(HOT_DOG));
		ItemGroupEvents.modifyEntriesEvent(ItemGroups.FOOD_AND_DRINK).register(entries -> entries.add(LOADED_DOG));
		...
		ItemGroupEvents.modifyEntriesEvent(ItemGroups.FOOD_AND_DRINK).register(entries -> entries.add(GLASS_MUG));
