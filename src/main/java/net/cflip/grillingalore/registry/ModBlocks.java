...
public class ModBlocks {
	...
	public static void register() {
		...
		Registry.register(Registry.BLOCK, new Identifier(GrillinGalore.MODID, "charcoal_grill"), CHARCOAL_GRILL);
		Registry.register(Registry.ITEM, new Identifier(GrillinGalore.MODID, "charcoal_grill"), new BlockItem(CHARCOAL_GRILL, new FabricItemSettings().group(ItemGroup.DECORATIONS)));
	}
}
